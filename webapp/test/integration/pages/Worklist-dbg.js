sap.ui.define([
	...
	"DIYTOOLS/DIY_TOOL/test/integration/pages/Common",
	"DIYTOOLS/DIY_TOOL/test/integration/pages/shareOptions"
		...
		onTheWorklistPage : {
					...
					return this.waitFor(createWaitForItemAtPosition({
						...
						success : function (oTableItem) {
							...
							this.getContext().currentItem = {
								...
								id: oBindingContext.getProperty("Actionid"),
								name: oBindingContext.getProperty("ActDesc")
							};
						}
					}));
				},
			...
			assertions: jQuery.extend({
				...
				theTableShouldHaveAllEntries : function () {
					...
					// retrieve all User_ActionSet to be able to check for the total amount
					this.waitFor(this.createAWaitForAnEntitySet({
						entitySet: "User_ActionSet",
